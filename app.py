...
with col1:
    ...
    <div class="instrucoes-card">
        ...
        <ol>
            ...
            <li><b>Processamento:</b> Clique em <b>"INICIAR AUDITORIA"</b>.</li>
            <li><b>Auditoria:</b> Verifique o <b>Diagnóstico</b> final para conferir divergências.</li>
            <li><b>Download:</b> Baixe o Excel ajustado para análise.</li>
        </ol>
    </div>
    """, unsafe_allow_html=True)
...
with col2:
    ...
    <div class="instrucoes-card">
        ...
        <ul>
            <li><b>Consolidação Universal:</b> Leitura de tags de SP, Nacional e centenas de prefeituras.</li>
            <li><b>Conferência de ISS:</b> Separação automática entre ISS Próprio e Retido.</li>
            <li><b>Alerta de Divergência:</b> Identificação visual de notas com retenções pendentes.</li>
            <li><b>Impostos Federais:</b> Extração direta de PIS, COFINS, CSLL e IRRF.</li>
        </ul>
    </div>
    """, unsafe_allow_html=True)
    ...
    if st.button("🚀 INICIAR AUDITORIA FISCAL"):
        ...
        with st.spinner("Analisando arquivos..."):
            ...
            if data_rows:
                ...
                st.error("Nenhum dado capturado.")
